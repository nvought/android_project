...
public class CourseAssessmentJuctionDBH extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = "c196CourseAssessmentJunction.db";
    public static final String TABLE_NAME = "course_assessment_junction_table";
    public static final String COL2 = "COURSEID";
    public static final String COL3 = "ASSESSMENTID";

    public CourseAssessmentJuctionDBH(Context context) {
    ...
    public void onCreate(SQLiteDatabase db) {
        String createTable = "CREATE TABLE " + TABLE_NAME +
                "( COURSEID TEXT, ASSESSMENTID TEXT)";
